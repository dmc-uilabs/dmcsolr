...
cd /tmp/dmcsolr
sudo -u solr -E sed "s/SOLR_DB_DNS/localhost/" -e "s/SOLR_DB_PORT/8983/" files/components.data-config.xml > /var/solr/data/gforge/components/conf/data-config.xml

# Edit companies.data-config.xml
sudo -u solr -E sed "s/SOLR_DB_DNS/localhost/" -e "s/SOLR_DB_PORT/8983/" files/companies.data-config.xml > /var/solr/data/gforge/companies/conf/data-config.xml

# Edit projects.data-config.xml
sudo -u solr -E sed "s/SOLR_DB_DNS/localhost/" -e "s/SOLR_DB_PORT/8983/" files/projects.data-config.xml > /var/solr/data/gforge/projects/conf/data-config.xml

# Edit services.data-config.xml
sudo -u solr -E sed "s/SOLR_DB_DNS/localhost/" -e "s/SOLR_DB_PORT/8983/" files/services.data-config.xml > /var/solr/data/gforge/services/conf/data-config.xml

# Edit users.data-config.xml
sudo -u solr -E sed "s/SOLR_DB_DNS/localhost/" -e "s/SOLR_DB_PORT/8983/" files/users.data-config.xml > /var/solr/data/gforge/users/conf/data-config.xml

# Edit wiki.data-config.xml
sudo -u solr -E sed "s/SOLR_DB_DNS/localhost/" -e "s/SOLR_DB_PORT/8983/" files/wiki.data-config.xml > /var/solr/data/gforge/wiki/conf/data-config.xml
